...
cd nasm-2.13.02  
./autogen.sh  
./configure  --prefix="/usr/local/ffmpeg_build"  --bindir="$HOME/bin"
make  
make install  
3. 安装Yasm
...
cd x264  
PKG_CONFIG_PATH="/usr/local/ffmpeg_build/lib/pkgconfig" ./configure --prefix="/usr/local/ffmpeg_build" --bindir="$HOME/bin" --enable-static
make  
make install  
5. 安装libx265
